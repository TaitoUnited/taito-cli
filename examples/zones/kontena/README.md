# Kontena Pharos example zone (TODO)

Example for a taito zone implemented with Kontena Pharos. Configure settings in `taito-config.sh` and then create the zone by running `taito zone apply`.
