...
function taito::core::print_command_with_internal_syntax () {
  ...
  local end_verbs=" add apply auth authenticate cancel change check clean connect continue copy copyquick quickcopy crawl create deploy develop destroy dump empty export forward generate get install import invalidate kill lint list ls manage merge migrate mount pause prepare publish rebase recreate release restore revert rotate run save scan set show start stop subscribe sync synchronize tag untag update upgrade verify wait "
