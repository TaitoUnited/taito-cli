...
function taito::core::print_command_with_internal_syntax () {
  ...
  local end_words="${end_verbs} ${end_prepositions} autocomplete contact conventions descriptions docs doctor diff down info log logs maintenance pr proxy readme revisions shell status trouble unit version "
